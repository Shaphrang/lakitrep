  ...
  return (
    <div className="space-y-4">
      ...
      <form className="grid gap-3 rounded-2xl border border-[#ddd4c6] bg-white p-4 sm:grid-cols-4">
        ...
        <input name="source" className={inputClass} placeholder="Booking source (Website, Phone, Agent...)" defaultValue={source} />
      ...
      <div className="rounded-2xl border border-[#ddd4c6] bg-white p-4">
        ...
        <form action={createOrUpdateCustomerAction} className="grid gap-3 sm:grid-cols-3">
          ...
          <label className="text-sm">Booking Source<input name="source" placeholder="Website, Phone Call, WhatsApp, Walk-in..." className={`${inputClass} mt-1 w-full`} /></label>
