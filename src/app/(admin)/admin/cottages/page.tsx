...
export default async function CottagesPage() {
  ...
  return (
    <div>
      <AdminPageHeader
        title="Cottages"
        description="Manage cottage inventory with future-ready fields."
        actions={<Link href="/admin/cottages/new" className="rounded-md bg-slate-900 px-4 py-2 text-sm text-white">New Cottage</Link>}
      />
