...
export function HeroBookingWidget({ cottages }: { cottages: PublicCottage[] }) {
  ...
  return (
    <aside className="w-full overflow-visible rounded-[30px] border border-[#ded3c3] bg-gradient-to-br from-[#fffaf0] via-[#fbf7ef] to-[#eef4ec] p-4 text-[#264330] shadow-[0_18px_48px_rgba(22,31,24,0.20)] backdrop-blur-xl sm:p-5 lg:max-w-[410px]">
      <div className="mb-4">
        ...
        {selected ? (
          <div className="rounded-2xl border border-[#e3d8c8] bg-[#fffdf8] px-3 py-2.5 text-xs text-[#5f6f64]">
            <div className="flex items-center justify-between gap-3">
              ...
              <span className="text-right font-bold text-[#244631]">
