...
-- Admin full access
drop policy if exists "admin_all_booking_payments" on public.booking_payments;
...
drop policy if exists "admin_all_booking_charges" on public.booking_charges;
create policy "admin_all_booking_charges"
...
drop policy if exists "admin_all_cottage_blocks" on public.cottage_blocks;
create policy "admin_all_cottage_blocks"
